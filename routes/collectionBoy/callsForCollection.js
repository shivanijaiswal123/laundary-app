...
router.post("/",verifyToken,(req,res)=>
{
    ...
    let query=`SELECT orders.order_id,flat_no,wings_name,society_name,customer_name,timestamp FROM mapping_collectionboy 
    ...
    WHERE orders.status='0' AND admin_id='${col_id}' AND time.status_id='0'`;
