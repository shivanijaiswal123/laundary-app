...
router.post("/", verifyToken, (req, res) => {
  ...
  let query = `SELECT orders.order_id,flat_no,wings_name,society_name,total_count,timestamp,customer_name     FROM mapping_supervisor      
  ...
  db.query(query, (err, result) => {
    if (err != null)
      ...
      } else return res.json({ message: "NO ORDERS NOW", success: false });
    }
  });
});
